 ...
 */
public class ChatClearHandler implements Handler<RoutingContext> {
  ...
  public ChatClearHandler(ChatManager chat, String key) {
    _chat = chat;
    _key = key;
  }
  @Override
  public void handle(RoutingContext event) {
    try {
      ...
      ChatClearRequest request = OBJECT_MAPPER.readValue(payload, ChatClearRequest.class);
  ...
  private void validateRequest(ChatClearRequest request) {
    Validate.notNull(request, "request cannot be null");
    Validate.notEmpty(request.getKey(), "key cannot be null/empty");
  }

  private void handleRequest(ChatClearRequest request, HttpServerResponse response) {
    // Check authorization
  ...
  private void handleAuthorized(ChatClearRequest request, HttpServerResponse response) {
